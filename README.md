...
AeroScript is a custom language interpreter, written in Go. It has C-style syntax, and is largely
...
I also made a simple programming language written using `AeroScript`.
...
We welcome contributions! If you make any changes to the language, please inform us so we can acknowledge your contributions in the `Credits` section.
